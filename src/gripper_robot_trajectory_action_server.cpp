...
#include <spw_robot/trajAction.h>
...
private:
	...
	void executeCB(const actionlib::SimpleActionServer<spw_robot::trajAction>::GoalConstPtr& goal);
	...
	actionlib::SimpleActionServer<spw_robot::trajAction> as_;

	// message types for the action
	spw_robot::trajActionGoal goal_; // goal message
	spw_robot::trajActionResult result_; // result message
	spw_robot::trajActionFeedback feedback_; // feedback message, not used
...
void TrajectoryActionServer::executeCB(const actionlib::SimpleActionServer<spw_robot::trajAction>::GoalConstPtr& goal) {
