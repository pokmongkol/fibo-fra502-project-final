...
private:
	...
	bool kpkvCallback(spw_robot::kpkv_msgRequest& request, spw_robot::kpkv_msgResponse& response);
	// service clients
...
bool Joint::kpkvCallback(spw_robot::kpkv_msgRequest& request, spw_robot::kpkv_msgResponse& response) {
